...
public class SysMLv2Lexer extends Lexer {
	...
	public static final int
		...
		T__24=25, T__25=26, K_DEPENDENCY=27, K_FROM=28, K_TO=29, K_COMMENT=30, 
		K_ABOUT=31, K_LOCALE=32, K_DOC=33, K_REP=34, K_LANGUAGE=35, K_METADATA=36, 
		K_DEF=37, K_ABSTRACT=38, K_REF=39, K_REDEFINES=40, K_STANDARD=41, K_LIBRARY=42, 
		K_PACKAGE=43, K_FILTER=44, K_ALIAS=45, K_FOR=46, K_IMPORT=47, K_ALL=48, 
		K_SPECIALIZES=49, K_ORDERED=50, K_NONUNIQUE=51, K_DEFINED=52, K_BY=53, 
		K_SUBSETS=54, K_REFERENCES=55, K_VARIATION=56, K_VARIANT=57, K_READONLY=58, 
		K_DERIVED=59, K_END=60, K_DEFAULT=61, K_ATTRIBUTE=62, K_ENUM=63, K_OCCURRENCE=64, 
		K_INDIVIDUAL=65, K_EVENT=66, K_THEN=67, K_ITEM=68, K_PART=69, K_PORT=70, 
		K_BINDING=71, K_BIND=72, K_SUCCESSION=73, K_FIRST=74, K_CONNECTION=75, 
		K_CONNECT=76, K_FLOW=77, K_MESSAGE=78, K_OF=79, K_INTERFACE=80, K_ALLOCATION=81, 
		K_ALLOCATE=82, K_ACTION=83, K_PERFORM=84, K_ACCEPT=85, K_VIA=86, K_AT=87, 
		K_AFTER=88, K_WHEN=89, K_SEND=90, K_ASSIGN=91, K_IF=92, K_ELSE=93, K_WHILE=94, 
		K_LOOP=95, K_UNTIL=96, K_IN=97, K_MERGE=98, K_DECIDE=99, K_JOIN=100, K_FORK=101, 
		K_STATE=102, K_PARALLEL=103, K_ENTRY=104, K_DO=105, K_EXIT=106, K_EXHIBIT=107, 
		K_TRANSITION=108, K_CALC=109, K_RETURN=110, K_CONSTRAINT=111, K_ASSERT=112, 
		K_NOT=113, K_REQUIREMENT=114, K_SUBJECT=115, K_ACTOR=116, K_STAKEHOLDER=117, 
		K_SATISFY=118, K_CONCERN=119, K_CASE=120, K_OBJECTIVE=121, K_ANALYSIS=122, 
		K_VERIFICATION=123, K_USE=124, K_INCLUDE=125, K_VIEW=126, K_RENDER=127, 
		K_RENDERING=128, K_EXPOSE=129, K_VIEWPOINT=130, K_IMPLIES=131, K_OR=132, 
		K_XOR=133, K_AND=134, K_HASTYPE=135, K_ISTYPE=136, K_AS=137, K_META=138, 
		K_NULL=139, K_TRUE=140, K_FALSE=141, K_PUBLIC=142, K_PRIVATE=143, K_PROTECTED=144, 
		K_OUT=145, K_INOUT=146, K_SNAPSHOT=147, K_TIMESLICE=148, K_ASSUME=149, 
		K_REQUIRE=150, K_FRAME=151, K_VERIFY=152, LANGLE=153, RANGLE=154, LBRACE=155, 
		RBRACE=156, RSQUARE=157, LSQUARE=158, LPAREN=159, RPAREN=160, OP_SEMI=161, 
		OP_COMMA=162, OP_AT=163, OP_HASH=164, OP_COLON_RANGLE_RANGLE=165, OP_COLON_COLON=166, 
		OP_STAR_STAR=167, OP_STAR=168, OP_COLON_RANGLE=169, OP_COLON=170, OP_COLON_COLON_RANGLE=171, 
		OP_DOT_DOT=172, OP_EQ=173, OP_COLON_EQ=174, OP_TILDE=175, OP_DOT=176, 
		OP_MINUS_RANGLE=177, OP_DOT_QMARK=178, OP_QMARK=179, OP_QMARK_QMARK=180, 
		OP_BAR=181, OP_AND=182, OP_EQ_EQ=183, OP_BANG_EQ=184, OP_EQ_EQ_EQ=185, 
		OP_BANG_EQ_EQ=186, OP_AT_AT=187, OP_LANGLE_EQ=188, OP_RANGLE_EQ=189, OP_PLUS=190, 
		OP_MINUS=191, OP_SLASH=192, OP_PERCENT=193, OP_HAT=194, RULE_DECIMAL_VALUE=195, 
		RULE_EXP_VALUE=196, RULE_ID=197, RULE_UNRESTRICTED_NAME=198, RULE_STRING_VALUE=199, 
		RULE_REGULAR_COMMENT=200, RULE_ML_NOTE=201, RULE_SL_NOTE=202, RULE_WS=203;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "K_DEPENDENCY", "K_FROM", "K_TO", "K_COMMENT", "K_ABOUT", "K_LOCALE", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'initialize'", "'compute'", "'cases'", "'infoflow'", "'handle'", "'guarantee'", 
			"'functions'", "'@strictpure'", "'@pure'", "'=>'", "'mut'", "'invariant'", 
			"'reads'", "'modifies'", "'match'", "'spec'", "'halt'", "'_'", "'val'", 
			"'var'", "'dependency'", "'from'", "'to'", "'comment'", "'about'", "'locale'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "K_DEPENDENCY", "K_FROM", "K_TO", "K_COMMENT", "K_ABOUT", 
			"K_LOCALE", "K_DOC", "K_REP", "K_LANGUAGE", "K_METADATA", "K_DEF", "K_ABSTRACT", 
			"K_REF", "K_REDEFINES", "K_STANDARD", "K_LIBRARY", "K_PACKAGE", "K_FILTER", 
			"K_ALIAS", "K_FOR", "K_IMPORT", "K_ALL", "K_SPECIALIZES", "K_ORDERED", 
			"K_NONUNIQUE", "K_DEFINED", "K_BY", "K_SUBSETS", "K_REFERENCES", "K_VARIATION", 
			"K_VARIANT", "K_READONLY", "K_DERIVED", "K_END", "K_DEFAULT", "K_ATTRIBUTE", 
